...
const AddTask = (props) => {
  ...
  return (
    <div className="lft h-[100%] w-[50%] bg-black flex items-center flex-col add-task">
...
onClick={() => {
  ...
  props.handleAdd && props.handleAdd();
          ...
          className='my-10 hover:bg-red-900 active:scale-90 rounded-sm font-bold p-1.5 cursor-pointer btn'
        >
          Create Task
        </button>
      </form>
